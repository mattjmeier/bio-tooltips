...
- Gene tooltips via MyGene.info[MyGene.info]
- Chemical tooltips via MyChem.info[MyChem.info]
...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bio-tooltips@2.0.2/dist/bio-tooltips.css">
<script src="https://cdn.jsdelivr.net/npm/bio-tooltips@2.0.2/dist/bio-tooltips.global.js"></script>
```
