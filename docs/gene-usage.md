...
The gene provider uses MyGene.info to resolve gene symbols and render gene-specific context.
...
The gene provider can show chromosome ideograms and gene tracks. Include D3 and Ideogram on pages that use those visuals.
