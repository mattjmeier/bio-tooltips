...
<p align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="_media/preview-dark.png">
    <img src="_media/preview.png" alt="Bio Tooltips preview: gene and chemical tooltips" width="900">
  </picture>
</p>
...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bio-tooltips@2.0.5/dist/bio-tooltips.css">
<script src="https://cdn.jsdelivr.net/npm/bio-tooltips@2.0.5/dist/bio-tooltips.global.js"></script>
```
